...
/** Readable text on light backgrounds (use for labels, helper text, secondary content). */
...
export const INPUT_FIELD_CLASSES =
  'w-full mt-1 h-12 px-4 py-3 rounded-2xl bg-card border border-border text-slate-900 text-base placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-ring';

/** Base Tailwind classes for multi-line textareas (e.g., captions). */
export const TEXTAREA_FIELD_CLASSES =
  'w-full mt-1 px-3 py-2.5 rounded-2xl bg-card border border-border text-slate-900 text-sm placeholder:text-slate-500 resize-none focus:outline-none focus:ring-2 focus:ring-ring';
